...
public class JDBCQuestionRepititionDAOV2 extends JDBCAdminComponentDAOV2 implements QuestionRepititionDAO {
	public JDBCQuestionRepititionDAOV2(DataSource dataSource) {
		super(dataSource);
	}
