...
public class JDBCQuestionInstructionDAOV2 extends JDBCInstructionDAOV2
  implements QuestionInstructionDAO {
  
	public JDBCQuestionInstructionDAOV2(DataSource dataSource) {
		super(dataSource);
	}
  ...
  public static void main(String[] args) {
    ...
    JDBCQuestionInstructionDAOV2 test = 
      new JDBCQuestionInstructionDAOV2(null);
