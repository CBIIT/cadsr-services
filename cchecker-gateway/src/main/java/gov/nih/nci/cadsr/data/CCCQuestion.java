...
List<String> raveUserString = new ArrayList<String>();
List<String> pvResults = new ArrayList<String>();
...
public List<String> getPvResults() {
	return pvResults;
}
public void setPvResults(List<String> pvResults) {
