...
Log file as of now:
log/cchecker-parser.log

The RESTful controller:
"AlsParserController"

"CCheckerParserService" controller class is the main application class. It also works as a controller for the root application page "/".

One can run Spring Boot application from Eclipse using a "CCheckerParserService" class, using right mouse button menu "Run as" -> "Spring Boot App".
...
4. It shall show "index" page, implemented by "CCheckerParserService" controller class. One see a text:
CCheckerParserService is running!
