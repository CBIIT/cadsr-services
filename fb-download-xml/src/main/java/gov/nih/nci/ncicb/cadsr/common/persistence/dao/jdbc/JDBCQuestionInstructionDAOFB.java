...
@Component("questionInstructionDAO")
public class JDBCQuestionInstructionDAOFB extends JDBCInstructionDAOFB implements QuestionInstructionDAO
{
  public JDBCQuestionInstructionDAOFB() {
    super();
  }
  ...
  public static void main(String[] args) {
    JDBCQuestionInstructionDAOFB test = 
      new JDBCQuestionInstructionDAOFB();
