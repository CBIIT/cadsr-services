...
@Component("referenceDocumentDAO")
public class JDBCReferenceDocumentDAOFB extends JDBCAdminComponentDAOFB implements ReferenceDocumentDAO
{
	public JDBCReferenceDocumentDAOFB() {
		super();
	}
