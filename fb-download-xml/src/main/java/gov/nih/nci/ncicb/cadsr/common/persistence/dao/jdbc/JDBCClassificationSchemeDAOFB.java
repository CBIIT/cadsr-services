...
@Component("classificationSchemeDAO")
public class JDBCClassificationSchemeDAOFB extends JDBCAdminComponentDAOFB implements ClassificationSchemeDAO
{
	public JDBCClassificationSchemeDAOFB() {
		super();
	}
