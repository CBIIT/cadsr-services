...
@Component("moduleInstructionDAO")
public class JDBCModuleInstructionDAOFB extends JDBCInstructionDAOFB implements ModuleInstructionDAO
{
	public JDBCModuleInstructionDAOFB() {
		super();
	}
	...
	public static void main(String[] args) {
		JDBCModuleInstructionDAOFB test = new JDBCModuleInstructionDAOFB();
