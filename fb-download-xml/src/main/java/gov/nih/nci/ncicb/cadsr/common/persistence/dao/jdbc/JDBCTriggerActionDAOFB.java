...
@Component("triggerActionDAO")
public class JDBCTriggerActionDAOFB extends JDBCAdminComponentDAOFB implements TriggerActionDAO
{
	public JDBCTriggerActionDAOFB()
	{
		super();
	}
