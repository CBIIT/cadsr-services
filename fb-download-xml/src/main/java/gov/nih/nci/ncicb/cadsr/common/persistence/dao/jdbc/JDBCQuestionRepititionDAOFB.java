...
@Component("questionRepititionDAO")
public class JDBCQuestionRepititionDAOFB extends JDBCAdminComponentDAOFB implements QuestionRepititionDAO
{
  public JDBCQuestionRepititionDAOFB() {
    super();
  }
