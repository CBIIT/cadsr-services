...
@Component("formValidValueInstructionDAO")
public class JDBCFormValidValueInstructionDAOFB extends JDBCInstructionDAOFB implements FormValidValueInstructionDAO
{
	public JDBCFormValidValueInstructionDAOFB() {
		super();
	}
	...
	public static void main(String[] args) {
		JDBCFormValidValueInstructionDAOFB test = 
				new JDBCFormValidValueInstructionDAOFB();
